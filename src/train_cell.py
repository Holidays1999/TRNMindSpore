...
class CustomTrainOneStepCell(nn.TrainOneStepWithLossScaleCell):
    """TrainOneStepWithEMA"""

    def __init__(self, network, optimizer, scale_sense=1.0, max_grad_norm=5):
        super(CustomTrainOneStepCell, self).__init__(network, optimizer, scale_sense)
        self.print = P.Print()
